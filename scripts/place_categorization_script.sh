...
do
    echo feature extraction: $file_name ...
    python ogm_feature_extract.py --file_name $file_name
done

for file_name in "${file_list[@]}"
do
    echo clustering: $file_name ...
    python ogm_feature_cluster.py --file_name $file_name --n_categories 2
    python ogm_feature_cluster.py --file_name $file_name --n_categories 3
    python ogm_feature_cluster.py --file_name $file_name --n_categories 4
    python ogm_feature_cluster.py --file_name $file_name --n_categories 5
done
